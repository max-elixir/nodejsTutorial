    ...
    async(req, res) => {
       ...
       // console.log(profileFields.skills);
        ...
        try {
            ...
            console.error(err.message);
            res.status(500).send('Server error: Create/Update');
        }
    });
...
router.get('/user/:user_id', async (req, res) => {
    try {
        ...
        res.status(500).send('Server error: Get single profile');
    }
});
...
router.put('/experience',
    ...
    async (req, res) => {
        ...
        try {
            ...
            console.error(err.message);
            res.status(500).send('Server error: Edit experience');
        }
});

//todo -- add Update experience, teach myself
...
router.put('/education',
    ...
    async (req, res) => {
        ...
        try {
            ...
            console.error(err.message);
            res.status(500).send('Server error: Edit education');
        }
    });

//todo -- add Update education, teach myself
